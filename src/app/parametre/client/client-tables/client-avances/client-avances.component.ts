...
@Component({
  selector: 'client-avances',
  templateUrl: './client-avances.component.html',
  styleUrl: './client-avances.component.scss'
})
export class ClientAvancesComponent implements OnInit,AfterViewInit{
