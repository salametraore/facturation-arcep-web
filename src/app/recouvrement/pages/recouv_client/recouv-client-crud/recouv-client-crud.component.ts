...
@Component({
  ...
  templateUrl: './recouv-client-crud.component.html'
})
export class RecouvClientCrudComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RecouvClientCrudComponent>,
