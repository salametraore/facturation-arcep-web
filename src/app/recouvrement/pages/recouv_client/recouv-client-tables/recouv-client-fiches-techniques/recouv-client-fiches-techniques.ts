...
@Component({
  selector: 'recouv-client-fiches-techniques',
  templateUrl: './recouv-client-fiches-techniques.html'
})
export class RecouvClientFichesTechniques implements OnInit,AfterViewInit{
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RecouvClientFichesTechniques>,
