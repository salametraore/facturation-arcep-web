...
@Component({
  selector: 'recouv-client-factures',
  templateUrl: './recouv-client-factures.component.html'
})
export class RecouvClientFacturesComponent implements OnInit,AfterViewInit{
  ...
  constructor(private factureService: FactureService,
              ...
              public dialogRef: MatDialogRef<RecouvClientFacturesComponent>,
