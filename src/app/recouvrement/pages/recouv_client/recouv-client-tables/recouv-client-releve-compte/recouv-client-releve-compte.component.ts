...
@Component({
  selector: 'recouv-client-releve-compte',
  templateUrl: './recouv-client-releve-compte.component.html'
})
export class RecouvClientReleveCompteComponent implements OnInit,AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RecouvClientReleveCompteComponent>,
