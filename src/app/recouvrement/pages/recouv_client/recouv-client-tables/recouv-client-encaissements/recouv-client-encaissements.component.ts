...
@Component({
  selector: 'recouv-client-encaissements',
  templateUrl: './recouv-client-encaissements.component.html'
})
export class RecouvClientEncaissementsComponent implements OnInit,AfterViewInit{
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RecouvClientEncaissementsComponent>,
