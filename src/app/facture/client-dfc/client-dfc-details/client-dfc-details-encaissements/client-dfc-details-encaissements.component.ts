...
@Component({
  selector: 'client-dfc-details-encaissements',
  templateUrl: './client-dfc-details-encaissements.component.html'
})
export class ClientDfcDetailsEncaissementsComponent implements OnInit, AfterViewInit {
