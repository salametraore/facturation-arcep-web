...
const routes: Routes = [
  {
    ...
    children: [
      ...
      withAccess('facture/domaines', { path: 'domaines', component: DomaineComponent }),
      withAccess('facture/service-confiance', { path: 'service-confiance', component: ServiceConfianceComponent }),
      withAccess('facture/elements-recu-dsi', { path: 'elements-recu-dsi', component: ElementsFactureRecuComponent }),
      withAccess('facture/encaissement', { path: 'encaissement', component: EncaissementComponent }),
      withAccess('facture/devis-facure', { path: 'devis-facure', component: DevisFactureComponent }),
      withAccess('facture/gestion-devis', { path: 'gestion-devis', component: GestionDevisComponent }),
      withAccess('facture/prestations-divers', { path: 'prestations-divers', component: FicherTechniqueDfcComponent }),
      withAccess('facture/service-a-valeur-ajoute', { path: 'service-a-valeur-ajoute', component: ServiceAValeurAjouteComponent }),
      withAccess('facture/autorisation-generale', { path: 'autorisation-generale', component: AutorisationGeneraleComponent }),
      withAccess('facture/autorisations-postales', { path: 'autorisations-postales', component: AutorisationsPostalesComponent }),
      withAccess('facture/agrement-installeur', { path: 'agrement-installeur', component: AgrementInstalleurComponent }),
      withAccess('facture/numerotation', { path: 'numerotation', component: NumerotationComponent }),
      withAccess('facture/agrement-equipement', { path: 'agrement-equipement', component: AgrementEquipementComponent }),
      withAccess('facture/frequences', { path: 'frequences', component: FrequencesComponent }),
      ...
      withAccess('facture/client-direction-technique', { path: 'client-direction-technique', component: ClientDirectionTechniqueComponent }),
      withAccess('facture/client-direction-technique-detail/:id', {
        path: 'client-direction-technique-detail/:id',
...

      {
        ...
        children: [
          withAccess('facture/activites-postales/:id/comptes', { path: ':id/comptes', component: ImportComptesComponent }),
          withAccess('facture/activites-postales/:id/traitement', { path: ':id/traitement', component: TraitementBilanComponent }),
          withAccess('facture/activites-postales/:id/recap', { path: ':id/recap', component: RecapRedevancesComponent }),
          withAccess('facture/activites-postales', { path: '', component: ImportDocumentsComponent }),
        ]
      },

      withAccess('facture/client-dfc', { path: 'client-dfc', component: ClientDfcComponent }),
      withAccess('facture/client-dfc-detail/:id', {
        path: 'client-dfc-detail/:id',
        component: ClientDfcDetailsComponent,
        resolve: { client: ClientResolver }
      }),

      withAccess('facture/fiche-techniques-activites-postales', {
        path: 'fiche-techniques-activites-postales',
        component: FicheTechniquesActivitesPostalesComponent
      }),

      withAccess('facture/generation-redevances-annuelles', {
        path: 'generation-redevances-annuelles',
        component: GenerationRedevanceComponent
      }),
    ]
  }
];
